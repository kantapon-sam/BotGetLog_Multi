...
public class BotToolLauncher {
    ...
    // Version 1.1.36: Add CPU and memory monitoring support to the TRUE Link Optical workflow and
    // prepare the automatic update package.
    private static final String FALLBACK_VERSION = "1.1.36";
