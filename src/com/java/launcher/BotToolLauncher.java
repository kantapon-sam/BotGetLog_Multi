...
public class BotToolLauncher {
    ...
    // Version 1.1.40: Prevent false TRUE site cleanup by counting only initial no-login failures.
    // Post-login session recovery failures are classified as connection failures, with improved
    // vendor login prompt and banner detection.
    private static final String FALLBACK_VERSION = "1.1.40";
