...
public class BotToolLauncher {
    ...
    // Version 1.1.35: Improve TRUE Link Optical checkpoint runs with a changed-log pre-scan before
    // thread 10 and one final full export.
    private static final String FALLBACK_VERSION = "1.1.35";
