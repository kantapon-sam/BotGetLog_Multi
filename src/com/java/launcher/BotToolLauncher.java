...
public class BotToolLauncher {
    ...
    // Version 1.1.47: Collect Nokia VPRN ARP and interface data by numeric Service ID; join ports
    // and status, read Model from equipment type, and read Node from the device prompt.
    private static final String FALLBACK_VERSION = "1.1.47";
